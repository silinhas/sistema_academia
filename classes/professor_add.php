 ...
 * Page class
 */
class professor_add extends professor
{
	...
	// Page object name
	public $PageObjName = "professor_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("idprofessor") !== NULL) {
				...
				$this->setKey("idprofessor", $this->idprofessor->CurrentValue); // Set up key
			} else {
				$this->setKey("idprofessor", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "professorview.php")
	...
	protected function loadDefaultValues()
	{
		...
		$this->idprofessor->OldValue = $this->idprofessor->CurrentValue;
		$this->nome_professor->CurrentValue = NULL;
		$this->nome_professor->OldValue = $this->nome_professor->CurrentValue;
	...
	protected function newRow()
	{
		...
		$row = [];
		$row['idprofessor'] = $this->idprofessor->CurrentValue;
		$row['nome_professor'] = $this->nome_professor->CurrentValue;
	...
	protected function addRow($rsold = NULL)
	{
		...
		// nome_professor
		$this->nome_professor->setDbValueDef($rsnew, $this->nome_professor->CurrentValue, NULL, FALSE);
