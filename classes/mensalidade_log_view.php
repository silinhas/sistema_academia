 ...
 * Page class
 */
class mensalidade_log_view extends mensalidade_log
{
	...
	// Page object name
	public $PageObjName = "mensalidade_log_view";
	...
	public function __construct()
	{
		...
		if (Get("idmensalidade_log") !== NULL) {
			$this->RecKey["idmensalidade_log"] = Get("idmensalidade_log");
			$keyUrl .= "&amp;idmensalidade_log=" . urlencode($this->RecKey["idmensalidade_log"]);
		}
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("idmensalidade_log") !== NULL) {
				...
				$this->RecKey["idmensalidade_log"] = $this->idmensalidade_log->QueryStringValue;
				...
				$this->RecKey["idmensalidade_log"] = $this->idmensalidade_log->FormValue;
			} elseif (IsApi() && Route(2) !== NULL) {
				$this->idmensalidade_log->setFormValue(Route(2));
				$this->RecKey["idmensalidade_log"] = $this->idmensalidade_log->FormValue;
			} else {
				$returnUrl = "mensalidade_loglist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "mensalidade_loglist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "mensalidade_loglist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
