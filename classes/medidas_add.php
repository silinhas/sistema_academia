 ...
 * Page class
 */
class medidas_add extends medidas
{
	...
	// Page object name
	public $PageObjName = "medidas_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("idmedidas") !== NULL) {
				...
				$this->setKey("idmedidas", $this->idmedidas->CurrentValue); // Set up key
			} else {
				$this->setKey("idmedidas", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "medidasview.php")
	...
	protected function loadDefaultValues()
	{
		...
		$this->idmedidas->OldValue = $this->idmedidas->CurrentValue;
		...
		$this->data_cadastro->CurrentValue = NULL;
		$this->data_cadastro->OldValue = $this->data_cadastro->CurrentValue;
	...
	protected function newRow()
	{
		...
		$row = [];
		$row['idmedidas'] = $this->idmedidas->CurrentValue;
		$row['altura'] = $this->altura->CurrentValue;
		$row['peso'] = $this->peso->CurrentValue;
		$row['data_cadastro'] = $this->data_cadastro->CurrentValue;
	...
	protected function addRow($rsold = NULL)
	{
		...
		// data_cadastro
		$this->data_cadastro->setDbValueDef($rsnew, UnFormatDateTime($this->data_cadastro->CurrentValue, 7), NULL, FALSE);
