 ...
 * Page class
 */
class agenda_log_add extends agenda_log
{
	...
	// Page object name
	public $PageObjName = "agenda_log_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("idagenda_log") !== NULL) {
				...
				$this->setKey("idagenda_log", $this->idagenda_log->CurrentValue); // Set up key
			} else {
				$this->setKey("idagenda_log", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "agenda_logview.php")
	...
	protected function loadDefaultValues()
	{
		...
		$this->idagenda_log->OldValue = $this->idagenda_log->CurrentValue;
		...
		$this->professor->CurrentValue = NULL;
		$this->professor->OldValue = $this->professor->CurrentValue;
	...
	protected function addRow($rsold = NULL)
	{
		...
		// data_now
		$this->data_now->setDbValueDef($rsnew, UnFormatDateTime($this->data_now->CurrentValue, 2), NULL, FALSE);

		// professor
		$this->professor->setDbValueDef($rsnew, $this->professor->CurrentValue, NULL, FALSE);
