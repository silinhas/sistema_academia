 ...
 * Page class
 */
class mensalidade_log_delete extends mensalidade_log
{
	...
	// Page object name
	public $PageObjName = "mensalidade_log_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("mensalidade_loglist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("mensalidade_loglist.php"); // Return to list
			}
		}
	}
