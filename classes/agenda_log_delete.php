 ...
 * Page class
 */
class agenda_log_delete extends agenda_log
{
	...
	// Page object name
	public $PageObjName = "agenda_log_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("agenda_loglist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("agenda_loglist.php"); // Return to list
			}
		}
	}
