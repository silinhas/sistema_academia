 ...
 * Page class
 */
class professor_delete extends professor
{
	...
	// Page object name
	public $PageObjName = "professor_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("professorlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("professorlist.php"); // Return to list
			}
		}
	}
