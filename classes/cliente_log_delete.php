 ...
 * Page class
 */
class cliente_log_delete extends cliente_log
{
	...
	// Page object name
	public $PageObjName = "cliente_log_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("cliente_loglist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("cliente_loglist.php"); // Return to list
			}
		}
	}
