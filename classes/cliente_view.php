 ...
 * Page class
 */
class cliente_view extends cliente
{
	...
	// Page object name
	public $PageObjName = "cliente_view";
	...
	public function __construct()
	{
		...
		if (Get("idcliente") !== NULL) {
			$this->RecKey["idcliente"] = Get("idcliente");
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("idcliente") !== NULL) {
				...
				$this->idcliente->setFormValue(Route(2));
				$this->RecKey["idcliente"] = $this->idcliente->FormValue;
			} else {
				$returnUrl = "clientelist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "clientelist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "clientelist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
