...
class agenda extends DbTable
{
	...
	public function __construct()
	{
		...
		// data
		$this->data = new DbField('agenda', 'agenda', 'x_data', 'data', '`data`', '`data`', 200, 45, -1, FALSE, '`data`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->data->Sortable = TRUE; // Allow sort
		$this->data->UsePleaseSelect = TRUE; // Use PleaseSelect by default
		$this->data->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
		switch ($CurrentLanguage) {
			case "pt-BR":
				$this->data->Lookup = new Lookup('data', 'agenda_log', FALSE, 'idagenda_log', ["data","","",""], [], [], [], [], [], [], '', '');
				break;
			default:
				$this->data->Lookup = new Lookup('data', 'agenda_log', FALSE, 'idagenda_log', ["data","","",""], [], [], [], [], [], [], '', '');
				break;
		...
		// hora
		$this->hora = new DbField('agenda', 'agenda', 'x_hora', 'hora', '`hora`', CastDateFieldForLike("`hora`", 4, "DB"), 134, 10, 4, FALSE, '`hora`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->hora->Sortable = TRUE; // Allow sort
		$this->hora->UsePleaseSelect = TRUE; // Use PleaseSelect by default
		$this->hora->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
		switch ($CurrentLanguage) {
			case "pt-BR":
				$this->hora->Lookup = new Lookup('hora', 'agenda_log', FALSE, 'idagenda_log', ["hora","","",""], [], [], [], [], [], [], '', '');
				break;
			default:
				$this->hora->Lookup = new Lookup('hora', 'agenda_log', FALSE, 'idagenda_log', ["hora","","",""], [], [], [], [], [], [], '', '');
				break;
		...
		// descricao
		$this->descricao = new DbField('agenda', 'agenda', 'x_descricao', 'descricao', '`descricao`', '`descricao`', 201, -1, -1, FALSE, '`descricao`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->descricao->UsePleaseSelect = TRUE; // Use PleaseSelect by default
		$this->descricao->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
		switch ($CurrentLanguage) {
			case "pt-BR":
				$this->descricao->Lookup = new Lookup('descricao', 'agenda_log', FALSE, 'idagenda_log', ["acao","","",""], [], [], [], [], [], [], '', '');
				break;
			default:
				$this->descricao->Lookup = new Lookup('descricao', 'agenda_log', FALSE, 'idagenda_log', ["acao","","",""], [], [], [], [], [], [], '', '');
				break;
		...
		// data_now
		$this->data_now = new DbField('agenda', 'agenda', 'x_data_now', 'data_now', '`data_now`', '`data_now`', 200, 45, -1, FALSE, '`data_now`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->data_now->Sortable = TRUE; // Allow sort
		$this->data_now->UsePleaseSelect = TRUE; // Use PleaseSelect by default
		$this->data_now->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
		switch ($CurrentLanguage) {
			case "pt-BR":
				$this->data_now->Lookup = new Lookup('data_now', 'agenda_log', FALSE, 'idagenda_log', ["data_now","","",""], [], [], [], [], [], [], '', '');
				break;
			default:
				$this->data_now->Lookup = new Lookup('data_now', 'agenda_log', FALSE, 'idagenda_log', ["data_now","","",""], [], [], [], [], [], [], '', '');
				break;
		...
		$this->professor_idprofessor = new DbField('agenda', 'agenda', 'x_professor_idprofessor', 'professor_idprofessor', '`professor_idprofessor`', '`professor_idprofessor`', 3, 11, -1, FALSE, '`professor_idprofessor`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->professor_idprofessor->Nullable = FALSE; // NOT NULL field
		$this->professor_idprofessor->Required = TRUE; // Required field
		$this->professor_idprofessor->Sortable = TRUE; // Allow sort
		$this->professor_idprofessor->UsePleaseSelect = TRUE; // Use PleaseSelect by default
		$this->professor_idprofessor->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
		switch ($CurrentLanguage) {
			case "pt-BR":
				$this->professor_idprofessor->Lookup = new Lookup('professor_idprofessor', 'professor', FALSE, 'idprofessor', ["nome_professor","","",""], [], [], [], [], [], [], '', '');
				break;
			default:
				$this->professor_idprofessor->Lookup = new Lookup('professor_idprofessor', 'professor', FALSE, 'idprofessor', ["nome_professor","","",""], [], [], [], [], [], [], '', '');
				break;
		}
		$this->professor_idprofessor->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['professor_idprofessor'] = &$this->professor_idprofessor;

		// cliente_idcliente
		$this->cliente_idcliente = new DbField('agenda', 'agenda', 'x_cliente_idcliente', 'cliente_idcliente', '`cliente_idcliente`', '`cliente_idcliente`', 3, 11, -1, FALSE, '`cliente_idcliente`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		switch ($CurrentLanguage) {
			case "pt-BR":
				$this->cliente_idcliente->Lookup = new Lookup('cliente_idcliente', 'cliente', FALSE, 'idcliente', ["nomeCliente","","",""], [], [], [], [], [], [], '', '');
				break;
			default:
				$this->cliente_idcliente->Lookup = new Lookup('cliente_idcliente', 'cliente', FALSE, 'idcliente', ["nomeCliente","","",""], [], [], [], [], [], [], '', '');
				break;
	...
	protected function loadDbValues(&$rs)
	{
		...
		$this->professor_idprofessor->DbValue = $row['professor_idprofessor'];
	...
	public function loadListRowValues(&$rs)
	{
		...
		$this->professor_idprofessor->setDbValue($rs->fields('professor_idprofessor'));
		...
		if (!$doc->ExportCustom) {
			...
			if ($doc->Horizontal) { // Horizontal format, write header
				...
				if ($exportPageType == "view") {
					...
					$doc->exportCaption($this->professor_idprofessor);
			...
			if ($recCnt >= $startRec) {
				...
				if (!$doc->ExportCustom) {
					...
					if ($exportPageType == "view") {
						...
						$doc->exportField($this->professor_idprofessor);
