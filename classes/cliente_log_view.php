 ...
 * Page class
 */
class cliente_log_view extends cliente_log
{
	...
	// Page object name
	public $PageObjName = "cliente_log_view";
	...
	public function __construct()
	{
		...
		if (Get("idcliente_log") !== NULL) {
			$this->RecKey["idcliente_log"] = Get("idcliente_log");
			$keyUrl .= "&amp;idcliente_log=" . urlencode($this->RecKey["idcliente_log"]);
		}
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("idcliente_log") !== NULL) {
				...
				$this->RecKey["idcliente_log"] = $this->idcliente_log->QueryStringValue;
				...
				$this->RecKey["idcliente_log"] = $this->idcliente_log->FormValue;
			} elseif (IsApi() && Route(2) !== NULL) {
				$this->idcliente_log->setFormValue(Route(2));
				$this->RecKey["idcliente_log"] = $this->idcliente_log->FormValue;
			} else {
				$returnUrl = "cliente_loglist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "cliente_loglist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "cliente_loglist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
