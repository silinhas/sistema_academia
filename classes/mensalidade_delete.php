 ...
 * Page class
 */
class mensalidade_delete extends mensalidade
{
	...
	// Page object name
	public $PageObjName = "mensalidade_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("mensalidadelist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("mensalidadelist.php"); // Return to list
			}
		}
	}
