 ...
 * Page class
 */
class mensalidade_log_add extends mensalidade_log
{
	...
	// Page object name
	public $PageObjName = "mensalidade_log_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("idmensalidade_log") !== NULL) {
				...
				$this->setKey("idmensalidade_log", $this->idmensalidade_log->CurrentValue); // Set up key
			} else {
				$this->setKey("idmensalidade_log", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "mensalidade_logview.php")
