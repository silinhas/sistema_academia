 ...
 * Page class
 */
class medidas_view extends medidas
{
	...
	// Page object name
	public $PageObjName = "medidas_view";
	...
	public function __construct()
	{
		...
		if (Get("idmedidas") !== NULL) {
			$this->RecKey["idmedidas"] = Get("idmedidas");
			$keyUrl .= "&amp;idmedidas=" . urlencode($this->RecKey["idmedidas"]);
		}
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("idmedidas") !== NULL) {
				...
				$this->RecKey["idmedidas"] = $this->idmedidas->QueryStringValue;
			} elseif (IsApi() && Key(0) !== NULL) {
				$this->idmedidas->setQueryStringValue(Key(0));
				$this->RecKey["idmedidas"] = $this->idmedidas->QueryStringValue;
			} elseif (Post("idmedidas") !== NULL) {
				$this->idmedidas->setFormValue(Post("idmedidas"));
				$this->RecKey["idmedidas"] = $this->idmedidas->FormValue;
			} elseif (IsApi() && Route(2) !== NULL) {
				$this->idmedidas->setFormValue(Route(2));
				$this->RecKey["idmedidas"] = $this->idmedidas->FormValue;
			} else {
				$returnUrl = "medidaslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "medidaslist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "medidaslist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
