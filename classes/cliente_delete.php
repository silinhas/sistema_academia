 ...
 * Page class
 */
class cliente_delete extends cliente
{
	...
	// Page object name
	public $PageObjName = "cliente_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("clientelist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("clientelist.php"); // Return to list
			}
		}
	}
