...
// Project
define(PROJECT_NAMESPACE . "PROJECT_NAME", "sistema_academia"); // Project name
...
$CONFIG = [
	...
	"RANDOM_KEY" => 'xA3qdkwpYZmMyDxJ', // Random key for encryption
	"ENCRYPTION_KEY" => '', // Encryption key for data protection
	"PROJECT_STYLESHEET_FILENAME" => "css/sistema_academia.css", // Project stylesheet file name
	...
	"PROJECT_ID" => "{5CB0D3D1-109E-4D29-B3C6-8A932EF252A0}", // Project ID (GUID)
	...
	"CONNECTION_INFO" => [
		"DB" => ["id" => "DB", "type" => "MYSQL", "qs" => "`", "qe" => "`", "host" => "localhost", "port" => "3306", "user" => "root", "pass" => "123456", "db" => "db_sistema"],
		"db_sistema1" => ["id" => "db_sistema1", "type" => "MYSQL", "qs" => "`", "qe" => "`", "host" => "localhost", "port" => "3306", "user" => "root", "pass" => "123456", "db" => "db_sistema", "new" => "true"]
	],
